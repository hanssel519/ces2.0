  ...
  <div class="wrapper m-md-2 pt-md-3">
    ...
    <div class="container m-md-2 pt-md-3">
      ...
      <div class="container mt-md-4">
        ...
        <div class="row align-items-center">
          <div class="col-8">
            <form class="form-validation" method="post" id="myForm" action="action/branchAdd.php">
            <div class="sub-entry">
                <div class="wrapper">
                    <div class="mt-md-3">
            ...
            <div class="sub-entry">
                <div class="wrapper">
                    ...
                    <div class="m-md-3">
                        ...
                        <input type="text" class="form-control" name="branchName" id="name" placeholder="Enter branch name" autocomplete="off" required>
                    </div>
                </div>
            </div>
